...
import Toast from "./Toast"; // ✅ استيراد Toast
...
const ReviewsList = () => {
  ...
  // ✅ حذف المنتج وإظهار Toast
  const handleDeleteReview = (productId) => {
    setReviews(prevReviews => prevReviews.filter(r => r.productId !== productId));
        ...
        <table className="table min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white">
            {groupedByProduct.map((productGroup, idx) => {
              const { productName, productImage, reviews, productId } = productGroup;
              const avgRating =
...
//     try {
//       await axios.delete(
//         `https://bakeryproject-1onw.onrender.com/api/products/${productId}/reviews/${reviewId}`
//       );
...
//                             key={review.id}
//                             onClick={() =>
//                               handleDeleteReview(review.productId, review.id)
//                             }
//                             className="flex items-center gap-1 bg-gray-600 hover:bg-gray-700 text-white text-xs py-1 px-2 rounded"
//                           >
//                             <FaTrash /> Delete
...
//               })
//             ) : (
//               // لو مفيش بيانات ولا حتى في فترة تحميل، نعطي رسالة فارغة
//               <tr>
//                 <td colSpan="6" className="text-center py-10 text-gray-500">
//                   {/* {loading ? 'Loading data...' : 'No reviews found.'} */}
//                   'No reviews found.
//                 </td>
//               </tr>
//             )}
