...
//             name: user.name,
//             email: user.email,
//             image: user.image || "/admin_image.jpg",
//             _id: user._id,
//           });
//         }
//       })
...
//   return (
//     <div className="min-h-screen w-full flex flex-col lg:flex-row bg-white py-28">
//       {/* Sidebar */}
//       <aside className="w-full lg:w-64 bg-pink-50 p-6 flex flex-col justify-between">
//               <div>
...
//                     { label: "Messages", icon: <MessageCircle className="w-5 h-5" />, id: "messages" },
//                     {
//                       label: "Favorites",
//                       icon: <Star className="w-5 h-5" />,
//                       id: "favorites",
//                       action: () => navigate("/favorites"), // ✅ التنقل إلى صفحة favorites
//                     },
//                     { label: "Notifications", icon: <Bell className="w-5 h-5" />, id: "notifications" },
//                     { label: "Activity", icon: <Clock className="w-5 h-5" />, id: "activity" },
//                     { label: "Settings", icon: <Settings className="w-5 h-5" />, id: "settings" },
//                     { label: "Help", icon: <HelpCircle className="w-5 h-5" />, id: "help" },
//                   ].map(({ label, icon, id, action }) => (
//                     <button
//                       key={id}
//                       onClick={() => {
//                         if (action) {
//                           action(); // إذا وُجدت دالة action نفذها
//                         } else {
//                           setActiveTab(id);
//                         }
//                       }}
...
//             <p className="text-gray-600">Help content will be available soon.</p>
//           </div>
//         )}
//       </main>
//     </div>
